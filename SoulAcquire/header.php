...
<meta name="description" content="Soul Acquire– an online tutorial website, covering Programming aspects .  A site where you would learn Programing with “ Simplicity, Efficiency and Quickness ”.  That’s what I believe in. Ensuring you an amazing and fun learning sessions., available to you at your desktop
	...
	<div class="header">
		<div class="container">
			<div class="header-main">
				<div class="logo">
			       <h1> <a href="index.php">SoulAcquire</a></h1>
			    </div>
				 <div class="top-nav">
			...
			<div class="banner-main">
				 <section class="slider">
						...
						<ul class="slides">
						  <li>
						  	<div class="banner-main">
								   <h3>Your Path to Online Learning Enrichment</h3>

...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message'])) {
		...
		if ($conn->query($sql) === true) {
			...
			$header = "From: bhatnagarkartik6@gmail.com"."\r\n"."Reply-To: $email";
			mail('bhatnagarkartik6@gmail.com',$sub,$body,$header);
			?>
			<script>
	...
	<div class="container">
		<div class="contact-main">
			...
			<div class="contact-block1">
			 	...
			 	<ul>
			    	<li><span class="glyphicon glyphicon-map-marker" aria-hidden="true"> </span><p>Administrator E-learning at NIETT</p></li>
			    	<li><span class="glyphicon glyphicon-phone" aria-hidden="true"> </span><p>99999999</p></li>
			    	<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span><p><a href="mailto:bhatnagarkaritk6@gmail.com">bhatnagarkaritk6@gmail.com</a></p></li>
			    </ul>
			 	</div>
